...
async def generate_session(bot, msg, telethon=False):
    ...
    text = "**{} STRING SESSION SUCCESSFULLY** \n\n`{}` \n\n**Generated by @BLVCKCARDS's**".format("TELETHON" if telethon else "PYROGRAM", string_session)
    try:
        await client.send_message("me", text)
    except KeyError:
        pass
    await client.disconnect()
    await phone_code_msg.reply("**__Successfully generated {} string session__**. \n\nPlease check your saved messages! \n\nBy @Stringsessiontelegrambot".format("telethon" if telethon else "pyrogram"))
